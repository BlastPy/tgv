...
def index(request):
    namep = NamePart.objects.all()
    rozdil = Rozdil.objects.all()
    context = {'rozdil': rozdil , 'namepart':namep }
...
def all_rozdil(request,is_main):
    ...
    context = {'stats':stats,'rozdil': rozdil,'title_rozdil':title_rozdil , 'namepart':namep }
...
def detali(request,id_ekz):
    ...
    rozdil = Rozdil.objects.all()
    context = {'details':details,'rozdil': rozdil,'namepart':namep}
